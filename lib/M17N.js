...
M17NHandle.prototype.ready=function()
{
	...
	function(ev)
	{
		...
		$(ev.data.handler.elId).html("<font style=\"color:#000055;font-size:12pt;\">"+ev.data.handler.mim.parsedBuffer   +"</font>"+
					     "<font style=\"color:#999999\">"+ev.data.handler.mim.tempBuffer     +"</font>");
	});
